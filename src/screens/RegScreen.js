...
const RegScreen = ({props, navigation}) => {
    ...
    return(
        <ScrollView style={{backgroundColor: "#f5f1f1"}}>
            <View style={authStyle.authContainer}>
                <Text style={authStyle.authTitle}>Регистрация</Text>
                ...
                {isPhoneSend && (
                    <>
                        <Text style={authStyle.authLabel}>Введите код</Text>
                        <TextInput
                            style={authStyle.authInput}
                            keyboarType="text"
                            onChangeText={ text =>{
                ...
                <TouchableOpacity style={{marginLeft: "auto", marginRight: "auto"}} onPress={handleSubmit(RegSubmit)}>
